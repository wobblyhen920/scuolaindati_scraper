...
"""
clean_long_snv.py — CSV long -> CSV long pulito (senza wide).

- drop 1.1.b.1 e righe con COLONNA == "label"
- 2.2.a.1: tieni solo "punteggio medio (1)" e "diff. escs (2)",
  splitta MODALITA su " - " / " | " -> SPLIT_A1..A3
- 2.2.b.2: rimuovi prefisso variabilità (anche mojibake),
  splitta COLONNA su " - " / " | " -> SPLIT_B1..B5
- in output toglie MODALITA, COLONNA, ORDINE_GRADO
  e aggiunge gli SPLIT_*
"""
...
def strip_var_prefix(col: str) -> str:
    """Toglie il prefisso 'variabilità dei punteggi - ' (e varianti mojibake)."""
        ...
        with open(args.inp, "r", newline="", encoding=args.encoding, errors="replace") as f_in:
            ...
            with open(tmp_out, "w", newline="", encoding="utf-8") as f_out:
                ...
                for line_no, row in enumerate(reader, start=2):
                    ...
                    # riga output senza i campi che non ci servono
